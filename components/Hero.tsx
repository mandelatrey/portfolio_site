...
const Hero = () => {
  return (
    <div className='pb-20 pt-36'>
        <div>  {/* background spotlights are here*/}
        ...
        dark:bg-grid-white/[0.05] bg-grid-black/[0.2] flex 
        ...
        <div className='flex justify-center relative my-20 z-10'>
            ...
            flex flex-col items-center justify-center'>
                ...
                text-xs text-center text-blue-100 max-w-80'>
                    Dynamic websites for every device
                </h2>
                <TextGenerateEffect 
                    className="text-center text-[40px] 
                    md:text-5xl lg:text-6xl tracking-tight e"
                    words='Making unique dynamic websites for your business' 
                />
                <p className="text-center md:tracking-normal mb-4 text-sm md:text-lg lg:text-2xl tracking-tighter">
                    Hi I&apos;m <span className='text-purple'>Trevor Mandela</span>, a Next-Js Developer based in Uganda.
                </p>
